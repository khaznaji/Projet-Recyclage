...
{ 
  ...
  $select=mysqli_query( $link,"select email,password from users where email='$email' and password='$pass'");
...
<body>
    ...
    <form method="post" action="submit_new.php" class="register-form">
    <input type="hidden" name="key" value="<?php echo $email;?>">
    <input type="hidden" name="reset" value="<?php echo $pass;?>">
    <p>Enter New password</p>
    <input type="password" name='password' class="form-control form-control-user" >
    <input type="submit" name="submit_password" class="btn btn-success btn-user btn-block mt-3">
    </form>
